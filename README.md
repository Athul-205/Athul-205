...
### 🚀 AI & Machine Learning Developer | Full-Stack AI Developer | B.Tech CSE (AI & ML)

Building intelligent software that solves real-world problems through Artificial Intelligence, Machine Learning, and Full-Stack Development.
...
`React 19` `TypeScript` `Vite` `Tailwind CSS v4` `Node.js` `Express.js` `Google Gemini API` `Recharts`
